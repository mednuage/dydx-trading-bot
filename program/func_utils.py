...
def format_number(curr_num,match_num):
    ...
    Function will return the correctly formatted format_number
    Permet de formater les prix selon le nombre de décimaux attendu selon les actifs
    """
...
# Get ISO times : COmme on ne peut pas extraire plus de 100 bougies, on va le faire en plusieurs fois sur plusieurs périodes
def get_ISO_times():

    # Get timestamps : Forcer l'historique de 400 bougies
